...
% \captionsetup[lstlisting]{
	% format=listing, labelfont=red, textfont=black, singlelinecheck=false, margin=0pt, font={bf,footnotesize} 
% }
\newcommand{\includecode}[6][c]{
	\lstinputlisting[caption=#3, escapechar=,label=code:#4,firstline=#5, lastline=#6]{#2}
}
